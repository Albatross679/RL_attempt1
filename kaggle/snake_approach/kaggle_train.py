#!/usr/bin/env python
"""
Kaggle training script for Snake Approach PPO task.
...
def main():
    ...
    print("=" * 60)
    run_cmd("python -m alf.bin.train --conf dismech-rl/confs/snake_approach_ppo_conf.py --root_dir /kaggle/working/snake_approach_results")
