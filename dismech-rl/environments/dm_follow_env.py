...
class DisMechFollowEnv(DisMechEnv):
    ...
    def __init__(self,
        ...
        # Set workspace dimension BEFORE calling super().__init__
        # so it's available when _create_new_sim is called
    ...
    def _custom_sim_params(self) -> None:
        # 2D simulation is now handled in SimParams (two_d_sim parameter)
        # set in dm_env.py based on self._ws_dim
        pass
